...
import br.com.guilherme.cursomc.domain.PagamentoComCartao;
...
import br.com.guilherme.cursomc.repository.EstadoRepository;
...
public class DBService {
	...
	public void intantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "guilhermecadastros19@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		Cliente cli2 = new Cliente(null, "Luana Oliveira", "guilhermecadastros192@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("99993323", "99858393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		
		Endereco e3 = new Endereco(null, "Avenida Florianópolis", "201", null, "Centro", "38777012", cli2, c2);
